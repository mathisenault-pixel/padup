          ...
          <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Suivez vos réservations et statistiques</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Activez, désactivez ou bloquez des créneaux</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Annulez des réservations en un clic</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-12 flex flex-col justify-center">
              ...
              <div className="space-y-4">
                ...
                <Link
                  href="/club/login"
                  className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] flex items-center justify-center gap-2"
                >
