...
export default async function PlayerAuthLayout({
  ...
  // TODO: Implémenter authentification avec Supabase
  // Pour l'instant, utilisateur fictif pour affichage UI
  const user = { email: 'demo@padup.com' }
            ...
            <div className="flex items-center gap-4">
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <Link 
                    href="/player/compte"
                    className="group relative px-6 py-3 bg-gradient-to-r from-gray-900 to-gray-800 hover:from-gray-800 hover:to-gray-700 text-white text-sm font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 overflow-hidden"
                  >
                ...
                <Link
                  href="/login"
                  className="group relative px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-sm font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
