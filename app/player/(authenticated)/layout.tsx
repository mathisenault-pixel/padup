...
export default function PlayerAuthLayout({
  ...
  return (
    <div className={`min-h-screen w-full overflow-x-hidden ${isAccueil ? '' : 'bg-white'}`}>
      ...
      <main className={`w-full overflow-x-hidden lg:pb-0 pb-[calc(2.4cm+env(safe-area-inset-bottom,0px))] ${isAccueil ? 'pt-[150px] lg:pt-40' : 'pt-14 lg:pt-[200px]'} min-h-screen`}>
        {children}
      </main>
