      ...
      <div className="w-full flex justify-center">
        ...
        >
          ...
          <button
            ...
            className={`flex items-center justify-center shrink-0 rounded-full bg-[#FF4567] text-white hover:bg-[#e63950] active:scale-95 transition-all -ml-[0.7cm] ${compact ? 'w-5 h-5 sm:w-6 sm:h-6 m-1' : 'w-7 h-7 sm:w-8 sm:h-8 m-1.5'}`}
