    ...
    return (
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button
          ...
          className="px-3 md:px-5 py-2 md:py-2.5 text-sm md:text-[14px] font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg md:rounded-xl transition-all duration-200 flex items-center gap-2"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
