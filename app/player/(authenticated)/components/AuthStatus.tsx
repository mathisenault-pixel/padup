  ...
  if (user) {
    return (
      <div className="flex items-center gap-3">
        ...
        <button
          type="button"
          onClick={() => router.push('/player/reservations')}
          className="px-5 py-2.5 text-[14px] font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-all duration-200 flex items-center gap-2"
        >
        ...
        <button
          ...
          className="px-5 py-2.5 text-[14px] font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-xl transition-all duration-200 flex items-center gap-2"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
