...
export default function MessagesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-3 md:px-6 pb-1 md:pb-3 max-w-[1400px]" style={{ marginTop: '-48px' }}>
        {/* En-tête */}
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden" style={{ height: 'calc(100vh - 132px)', minHeight: '500px' }}>
