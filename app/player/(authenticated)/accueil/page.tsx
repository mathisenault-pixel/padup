...
export default function AccueilPage() {
  ...
  return (
    <div>
      ...
      <section
        className="relative w-screen min-h-screen overflow-hidden left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] flex items-center justify-center bg-cover bg-no-repeat hero-bg-position"
        style={{
